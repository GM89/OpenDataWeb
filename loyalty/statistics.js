/* 
import {data, members_array} from "/pro-congress-113-senate.js"; */
...
for (i=0; i < members_array.length;i++){
 ...
 voted_with_party_average_ID = (voted_with_party_total_ID / total_Ind.length).toFixed(2);
...
let list_highest_tenth =senators_sort_ascending.slice(highest_tenth_index, -1).reverse();
...
//----------------ATTENDANCE----------------------------------------------
//------------------------------ formulas --------------------
if(window.location.href.includes('senate_house-attendance-starter-page.html')){
...
const senators_missed_v_ascending = members_array.sort(function(a,b) {
  const lastPerson = a.missed_votes_pct;
  const nextPerson = b.missed_votes_pct;
  if (lastPerson < nextPerson) {
    return -1;
  } else {
    return 1;
...
//there are  105 senatoirs 
lowest_tenth = Math.ceil(members_array.length * 0.10);
highest_tenth= members_array.length -lowest_tenth;
...
let lowest_attendance = senators_missed_v_ascending[lowest_tenth_index].missed_votes_pct;
console.log('lowest_attendance: ');
console.log(lowest_attendance);

let first_highest_attendance = senators_missed_v_ascending[highest_tenth_index].missed_votes_pct;
console.log('first_highest_attendance: ');
console.log(first_highest_attendance);

//--


let list_highest_attendance = senators_missed_v_ascending.slice(0, (lowest_tenth_index +1));
let list_lowest_attendance =senators_missed_v_ascending.slice(highest_tenth_index, -1).reverse();
console.log('list_lowest_attendance')
console.log(list_lowest_attendance);
console.log('list_highest_attendance')
console.log(list_highest_attendance);
...
let table_most_engaged = document.getElementById("most_engaged");
/* let tbody_tle = document.getElementById('least_loyal').getElementsByTagName('tbody')[0]; */
let tbody_attendance = document.getElementById('least_engaged').getElementsByTagName('tbody')[0];
//loyalty_table('table_least_loyal', list_lowest_tenth)




  function attendance_table(array){
       
        for (i=0; i < array.length;i++){
              // Create row
            
              let newRow = tbody_attendance.insertRow(i);
              //Create cells
              let newCell0 = newRow.insertCell(0);
              let newCell1 = newRow.insertCell(1);
              let newCell2 = newRow.insertCell(2);
            ...
            // adding text
            /*   newCell0.textContent = (list_lowest_tenth[i].first_name + " " + (list_lowest_tenth[i].middle_name || "")  +" "+ list_lowest_tenth[i].last_name) */
              newCell1.textContent = array[i].missed_votes;
              newCell2.textContent = array[i].missed_votes_pct;
            }

  }
  attendance_table(list_lowest_attendance);


  tbody_attendance = document.getElementById('most_engaged').getElementsByTagName('tbody')[0];
  //loyalty_table('table_least_loyal', list_lowest_tenth)

  attendance_table(list_highest_attendance);
